...
BEGIN_MESSAGE_MAP(CWMSClientApp, CWinApp)
...
// 僅有的一個 CWMSClientApp 物件

CWMSClientApp theApp;


// CWMSClientApp 初始設定

BOOL CWMSClientApp::InitInstance()
{
