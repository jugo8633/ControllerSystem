...
enum EVENT_FILTER
{
	WIRELESS_MANAGER = 1, SOCKET_SERVER,
};

#define EVENT_FILTER					2000
#define EVENT_FILTER_WIRELESS_MANAGER		(EVENT_FILTER + WIRELESS_MANAGER)
...
#define EVENT_COMMAND_SOCKET_WMS_RECEIVE		(EVENT_COMMAND + EVENT_SERVER_DOMAIN)
